<style>
    ...
    .hero-one {
        ...
        z-index: 1;
        background-image:linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url({{ asset('/uploads/other/pink.avif') }});
    ...
    .hero-two {
        ...
        height: 100vh;
        background-image: linear-gradient(rgba(0,0,0,.2), rgba(0,0,0,.5)), url({{ asset('/uploads/other/hero2.jpeg') }});
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
    }
